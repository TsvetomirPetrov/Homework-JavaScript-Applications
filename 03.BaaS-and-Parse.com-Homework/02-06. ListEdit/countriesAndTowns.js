$(function(){
    var PARSE_APP_ID = "VwIqOOKKLqXED4Fvq0EvrvO5iR9GZglwaIz1LOu9";
    var PARSE_REST_API_KEY = "NJN4CjvQQXUp0PzVlrN7L0GrOJ1GPcMWtsS9x6ZI";
    ...
    function loadTowns(){
        ...
        $.ajax({
            ...
            url: 'https://api.parse.com/1/classes/Town?where={"country":{"__type":"Pointer","className":"Country_","objectId":"' + country.name + '"}}',
            success: townsLoaded,
            error: error
        });
    }
